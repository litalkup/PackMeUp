...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'dupe.applyAll': 'Do the same for the rest of this import',
      ...
      'menu.reorder': 'Reorder items',
      'reorder.on': 'Reordering — move items with the arrows',
      'reorder.done': 'Done',
      'item.moveUp': 'Move {name} up',
      'item.moveDown': 'Move {name} down',
      'cats.menu': 'Categories',
      'cats.title': 'Categories',
      'cats.yours': 'Your categories',
      'cats.none': 'You have not added any categories yet.',
      'cats.builtIn': 'The {count} built-in categories are always there.',
      'cats.add': 'New category',
      'cats.name': 'Category name',
      'cats.namePlaceholder': 'e.g. Photo gear',
      'cats.icon': 'Icon',
      'cats.create': 'Create',
      'cats.added': 'Category added',
      'cats.deleted': 'Category removed',
      'cats.deleteTitle': 'Delete “{name}”?',
      'cats.deleteBody': 'Items filed under it move to Other. You can undo this straight after.',
      'cats.newOption': '➕ New category…',
      'cats.itemCount': '{count} in this category',
      'drive.menu': 'Sync with Google Drive',
      'drive.title': 'Sync with Google Drive',
      'drive.what': 'Your lists are kept in one file in this app\u2019s own private folder in your Drive. No other app and none of your other files can see it, and nothing passes through a server of mine. Each device merges that file with what it has, so you can edit on both.',
      'drive.setupTitle': 'One-time setup',
      'drive.setupBody': 'Google only lets an app reach a Drive account through a client ID that you create. In the Google Cloud console: create a project, enable the Google Drive API, then under Clients create an OAuth client ID of type Web application with {origin} as an authorised JavaScript origin. Add yourself as a test user on the consent screen. Paste the client ID below.',
      'drive.setupWarning': 'The first sign-in shows an “unverified app” warning, because publishing an app with Drive access needs a Google review. Choose Advanced, then continue - it is your own app reaching your own Drive.',
      'drive.clientId': 'OAuth client ID',
      'drive.clientIdPlaceholder': '…apps.googleusercontent.com',
      'drive.save': 'Save',
      'drive.connect': 'Connect and sync',
      'drive.syncNow': 'Sync now',
      'drive.disconnect': 'Disconnect',
      'drive.auto': 'Sync by itself when something changes',
      'drive.status.off': 'Not connected yet',
      'drive.status.never': 'Connected, nothing synced yet',
      'drive.status.at': 'Last synced {when}',
      'drive.syncing': 'Syncing…',
      'drive.synced': 'Synced',
      'drive.syncedMerged': 'Synced · {merged} merged from your other device',
      'drive.noClientId': 'Add the OAuth client ID first',
      'drive.noScript': 'Could not reach Google to sign in',
      'drive.noToken': 'Sign-in was not completed',
      'drive.denied': 'Google refused the request — try connecting again',
      'drive.failed': 'Drive did not answer as expected',
      'drive.badFile': 'The file in Drive could not be read — nothing here was changed',
      'drive.busy': 'A sync is already running',
      'note.menu': 'Import from a note (Google Keep)',
      'note.title': 'Import a note',
      'note.paste': 'Paste the note',
      'note.placeholder': 'Trip to Greece\n☑ Passport\n☐ 3 x socks\n☐ Toothbrush',
      'note.hint': 'Open the note in Google Keep, select everything, copy, and paste it here. Checkboxes are understood, and anything already ticked in the note arrives packed.',
      'note.shareHint': 'On Android you can skip the copying: in Keep, ⋮ → Send → PackMeUp.',
      'note.target': 'Where should it go?',
      'note.newList': 'Into a new list',
      'note.existingList': 'Into an existing list',
      'note.listName': 'Name of the new list',
      'note.preview': '{items} found, {packed} of them already ticked',
      'note.previewPlain': '{items} found',
      'note.previewNone': 'No items found yet',
      'note.action': 'Import',
      'note.empty': 'Paste a note first',
      'note.sharedTitle': 'A note was shared with PackMeUp',
      ...
      'menu.import': 'Restore from a backup file (.json)',
      ...
      'import.hint': 'Imported lists merge with what you already have: the same list coming back from another device is recognised, not copied. The newer edit of each item wins.',
      'import.action': 'Import',
      'import.needFile': 'Choose a file or paste a backup first',
      'import.done': 'Imported: {count}',
      'import.doneMerged': 'Imported: {count} · {merged} merged into lists you already had',
      'import.badJson': 'That file is not valid JSON.',
      'import.noLists': 'No packing lists found in that file.',
      'import.failed': 'Import failed',
      'import.looksLikeNote': 'That looks like a note rather than a backup file — opening the note importer.',
    ...
    he: {
      ...
      'dupe.applyAll': 'לעשות אותו דבר בכל שאר הכפילויות',
      ...
      'menu.reorder': 'שינוי סדר פריטים',
      'reorder.on': 'מצב סידור — אפשר להזיז עם החצים',
      'reorder.done': 'סיום',
      'item.moveUp': 'הזזת {name} למעלה',
      'item.moveDown': 'הזזת {name} למטה',
      'cats.menu': 'קטגוריות',
      'cats.title': 'קטגוריות',
      'cats.yours': 'הקטגוריות שלך',
      'cats.none': 'עדיין לא הוספת קטגוריות.',
      'cats.builtIn': '{count} הקטגוריות המובנות תמיד קיימות.',
      'cats.add': 'קטגוריה חדשה',
      'cats.name': 'שם הקטגוריה',
      'cats.namePlaceholder': 'למשל: ציוד צילום',
      'cats.icon': 'סמל',
      'cats.create': 'יצירה',
      'cats.added': 'הקטגוריה נוספה',
      'cats.deleted': 'הקטגוריה נמחקה',
      'cats.deleteTitle': 'למחוק את ״{name}״?',
      'cats.deleteBody': 'הפריטים שמסודרים תחתיה יעברו ל״שונות״. אפשר לבטל מיד אחר כך.',
      'cats.newOption': '➕ קטגוריה חדשה…',
      'cats.itemCount': '{count} בקטגוריה הזאת',
      'drive.menu': 'סנכרון עם Google Drive',
      'drive.title': 'סנכרון עם Google Drive',
      'drive.what': 'הרשימות נשמרות בקובץ אחד בתיקייה הפרטית של האפליקציה בדרייב שלך. שום אפליקציה אחרת ושום קובץ אחר שלך לא רואים אותה, וכלום לא עובר דרך שרת שלי. כל מכשיר ממזג את הקובץ עם מה שיש לו, כך שאפשר לערוך בשניהם.',
      'drive.setupTitle': 'הגדרה חד-פעמית',
      'drive.setupBody': 'גוגל מאפשרת לאפליקציה לגשת לדרייב רק דרך מזהה לקוח שאת יוצרת. ב-Google Cloud console: ליצור פרויקט, להפעיל את Google Drive API, ואז תחת Clients ליצור OAuth client ID מסוג Web application עם {origin} כמקור JavaScript מורשה. להוסיף את עצמך כמשתמשת בדיקה במסך ההסכמה. להדביק כאן את המזהה.',
      'drive.setupWarning': 'בהתחברות הראשונה יופיע מסך אזהרה על ״אפליקציה לא מאומתת״, כי פרסום אפליקציה עם גישה לדרייב דורש בדיקה של גוגל. לוחצים על ״מתקדם״ וממשיכים — זו האפליקציה שלך שניגשת לדרייב שלך.',
      'drive.clientId': 'מזהה לקוח (OAuth client ID)',
      'drive.clientIdPlaceholder': '‎…apps.googleusercontent.com',
      'drive.save': 'שמירה',
      'drive.connect': 'התחברות וסנכרון',
      'drive.syncNow': 'סנכרון עכשיו',
      'drive.disconnect': 'ניתוק',
      'drive.auto': 'לסנכרן לבד כשמשהו משתנה',
      'drive.status.off': 'עדיין לא מחובר',
      'drive.status.never': 'מחובר, עוד לא סונכרן',
      'drive.status.at': 'סונכרן לאחרונה {when}',
      'drive.syncing': 'מסנכרן…',
      'drive.synced': 'סונכרן',
      'drive.syncedMerged': 'סונכרן · {merged} מוזגו מהמכשיר השני',
      'drive.noClientId': 'צריך להזין קודם מזהה לקוח',
      'drive.noScript': 'לא הצלחתי להגיע לגוגל כדי להתחבר',
      'drive.noToken': 'ההתחברות לא הושלמה',
      'drive.denied': 'גוגל דחתה את הבקשה — כדאי להתחבר מחדש',
      'drive.failed': 'דרייב לא ענה כמצופה',
      'drive.badFile': 'לא הצלחתי לקרוא את הקובץ בדרייב — כאן שום דבר לא השתנה',
      'drive.busy': 'סנכרון כבר רץ',
      'note.menu': 'ייבוא מפתק (Google Keep)',
      'note.title': 'ייבוא פתק',
      'note.paste': 'הדבקת הפתק',
      'note.placeholder': 'טיול ליוון\n☑ דרכון\n☐ 3 גרביים\n☐ מברשת שיניים',
      'note.hint': 'פותחים את הפתק ב-Google Keep, בוחרים הכול, מעתיקים ומדביקים כאן. תיבות הסימון מזוהות, ומה שכבר מסומן בפתק מגיע ארוז.',
      'note.shareHint': 'באנדרואיד אפשר לוותר על ההעתקה: ב-Keep, ⋮ ← שליחה ← PackMeUp — והפתק מגיע לכאן לבד.',
      'note.target': 'לאן להוסיף?',
      'note.newList': 'לרשימה חדשה',
      'note.existingList': 'לרשימה קיימת',
      'note.listName': 'שם הרשימה החדשה',
      'note.preview': 'זוהו {items}, {packed} מהם כבר מסומנים',
      'note.previewPlain': 'זוהו {items}',
      'note.previewNone': 'עדיין לא זוהו פריטים',
      'note.action': 'ייבוא',
      'note.empty': 'צריך להדביק פתק קודם',
      'note.sharedTitle': 'פתק שותף אל PackMeUp',
      ...
      'menu.import': 'שחזור מקובץ גיבוי (‎.json)',
      ...
      'import.hint': 'רשימות מיובאות מתמזגות עם מה שכבר קיים: אותה רשימה שחוזרת ממכשיר אחר מזוהה ולא משוכפלת. בכל פריט מנצח העדכון החדש יותר.',
      'import.action': 'ייבוא',
      'import.needFile': 'צריך לבחור קובץ או להדביק גיבוי',
      'import.done': 'ייבוא: {count}',
      'import.doneMerged': 'ייבוא: {count} · {merged} מוזגו לרשימות שכבר היו לך',
      'import.badJson': 'הקובץ הזה אינו JSON תקין.',
      'import.noLists': 'לא נמצאו רשימות אריזה בקובץ הזה.',
      'import.failed': 'הייבוא נכשל',
      'import.looksLikeNote': 'זה נראה כמו פתק ולא כמו קובץ גיבוי — פותח את ייבוא הפתק.',
