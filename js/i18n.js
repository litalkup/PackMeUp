...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'cats.scope': 'Where should it be available?',
      'cats.scopeList': 'Only in “{name}”',
      'cats.scopeAll': 'In all lists',
      'cats.scopeListShort': 'only in “{name}”',
      'cats.scopeAllShort': 'in all lists',
      'cats.addedTo': 'Added to “{name}”',
      'cats.addedEverywhere': 'Added to all lists',
      ...
      'menu.undo': 'Undo: {label}',
      'plural.step.one': '{n} step available',
      'plural.step.other': '{n} steps available',
      'undo.created': 'Created \u201c{name}\u201d',
      'undo.duplicated': 'Duplicated \u201c{name}\u201d',
      'undo.deletedList': 'Deleted \u201c{name}\u201d',
      'undo.updatedList': 'Updated \u201c{name}\u201d',
      'undo.removedItem': 'Removed \u201c{name}\u201d',
      'undo.updatedItem': 'Updated \u201c{name}\u201d',
      'undo.addedItem': 'Added \u201c{name}\u201d',
      'undo.addedItems': 'Added {n} items',
      'undo.checkedAll': 'Checked everything',
      'undo.uncheckedAll': 'Unchecked everything',
      'undo.removedPacked': 'Removed packed items',
      'undo.recategorized': 'Re-sorted categories',
      'undo.addedCategory': 'Added category \u201c{name}\u201d',
      'undo.updatedCategory': 'Updated category \u201c{name}\u201d',
      'undo.removedCategory': 'Removed category \u201c{name}\u201d',
      'undo.imported': 'Imported lists',
    ...
    he: {
      ...
      'cats.scope': 'איפה היא תהיה זמינה?',
      'cats.scopeList': 'רק ב״{name}״',
      'cats.scopeAll': 'בכל הרשימות',
      'cats.scopeListShort': 'רק ב״{name}״',
      'cats.scopeAllShort': 'בכל הרשימות',
      'cats.addedTo': 'נוספה ל״{name}״',
      'cats.addedEverywhere': 'נוספה לכל הרשימות',
      ...
      'menu.undo': 'ביטול: {label}',
      'plural.step.one': 'צעד אחד זמין',
      'plural.step.other': '{n} צעדים זמינים',
      'undo.created': 'נוצרה ״{name}״',
      'undo.duplicated': 'שוכפלה ״{name}״',
      'undo.deletedList': 'נמחקה ״{name}״',
      'undo.updatedList': 'עודכנה ״{name}״',
      'undo.removedItem': 'הוסר ״{name}״',
      'undo.updatedItem': 'עודכן ״{name}״',
      'undo.addedItem': 'נוסף ״{name}״',
      'undo.addedItems': 'נוספו {n} פריטים',
      'undo.checkedAll': 'הכול סומן',
      'undo.uncheckedAll': 'כל הסימונים בוטלו',
      'undo.removedPacked': 'פריטים ארוזים הוסרו',
      'undo.recategorized': 'הקטגוריות סודרו מחדש',
      'undo.addedCategory': 'נוספה קטגוריה ״{name}״',
      'undo.updatedCategory': 'עודכנה קטגוריה ״{name}״',
      'undo.removedCategory': 'קטגוריה ״{name}״ הוסרה',
      'undo.imported': 'רשימות יובאו',
